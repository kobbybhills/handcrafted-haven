        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { name: "Home Decor", img: "/categories/decor.webp" },
              ...
              >
                <div className="h-48 bg-gray-200 flex items-center justify-center">
                  <div className="h-48 w-full relative">
                    <Image
                      src={cat.img} // dynamic from the array
                      alt={cat.name}
                      fill
                  ...
                  <p className="text-haven-dark-green font-medium">
                    {cat.name}
                  </p>
                </div>
      ...
      <section className="py-16 bg-haven-dark-green text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg md:text-xl mb-10 opacity-90">
            Every piece tells a story. Join our community of makers and
            collectors today.
          </p>
          <a
            href="/register"
